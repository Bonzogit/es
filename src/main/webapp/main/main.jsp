    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="${app}/admin/exit">退出登录 <span class="glyphicon glyphicon-log-out"></span></a>
...
<div class="container-fluid">
    <div class="row">
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel"
                        ...
                        <div class="panel-body">
                            <a href="javascript:$('#aaa').load('index.jsp')">用户列表</a>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                        <div class="panel-body">
                            <a href="javascript:$('#aaa').load('index2.jsp')">上师列表</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="panel-body">
                            <a href="javascript:$('#aaa').load('article.jsp')">文章列表</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="panel-body">
                            <a href="javascript:$('#aaa').load('album.jsp')">专辑列表</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="panel-body">
                            <a href="javascript:$('#aaa').load('banner.jsp')">轮播图列表</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-10" id="aaa">
            <div class="panel panel-default">
                <div class="panel-heading"><h3>欢迎来到持明法州后台管理系统</h3></div>

            </div>
            <img src="../img/shouye.jpg" class="img-rounded">
